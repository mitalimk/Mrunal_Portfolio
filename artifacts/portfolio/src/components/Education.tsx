    ...
    <div ref={ref} className="relative flex gap-6 group">
      ...
      <div className="flex flex-col items-center">
        <motion.div
          ...
          style={{
            boxShadow: isInView ? "0 0 20px rgba(74,222,128,0.4)" : "none",
          }}
        >
          {edu.icon}
        </motion.div>
      ...
      <motion.div
        ...
        whileHover={{ y: -4, boxShadow: "0 0 24px rgba(74,222,128,0.18)" }}
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, delay: index * 0.22 + 0.5 }}
        ...
        {isInView && (
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(to bottom, transparent 0%, rgba(74,222,128,0.08) 50%, transparent 100%)",
              height: "60px",
            }}
            initial={{ y: -60 }}
            animate={{ y: "100%" }}
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-3">
          <div className="flex-1">
            ...
            <p className="text-muted-foreground/60 text-sm font-mono mt-0.5">
              {edu.location}
            </p>
          </div>
          <div className="flex flex-col items-start md:items-end font-mono text-sm gap-1 flex-shrink-0">
            <motion.span
              ...
              transition={{ delay: index * 0.22 + 0.6 }}
            >
              {edu.score}
            </motion.span>
